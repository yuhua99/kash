...
<template>
  <div class="min-h-screen p-8 flex items-center justify-center">
    ...
    >
      ...
      <Block v-if="activeView === 'overview'" key="balance" label="Balance">
      ...
      <Block v-if="activeView === 'overview'" key="quick-add" label="Quick Add">
        ...
        <p class="font-mono text-xs text-[var(--text-muted)]">Format: amount category</p>
      </Block>
      ...
      <Block
        ...
        :class="{
          'md:col-span-2': activeView === 'overview',
          'lg:col-span-2 lg:row-span-2': activeView === 'transactions',
        }"
      >
        <template #headerRight>
          <button
        ...
        <div
          ...
          :class="activeView === 'transactions' ? 'max-h-[600px]' : ''"
        >
          <div
      ...
      <Block v-if="activeView === 'transactions'" key="period-filter" label="Time Period">
        <div class="flex-1 flex flex-col justify-center">
          <Select v-model="selectedPeriod" :options="periodOptions" class="w-full" />
      ...
      <Block key="analytics" label="Analytics">
        <div class="flex-1 flex flex-col justify-end">
          ...
          <p class="font-mono text-xs text-center border-t border-black pt-2 mt-3">
